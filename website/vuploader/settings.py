...
SECRET_KEY = 'django-insecure-0z5esa%jglgz@+6mxpw8qs+p%p!r80e2)5oh1-#0&#z-+abh4l'
...
#-----------------------------------------------------------------------------
# # Media files settings for the root base_dir
...
#Media file settings like this can be used  
# import os
